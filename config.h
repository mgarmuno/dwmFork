...
static const char *chromium[]          = { "torbrowser-launcher", NULL };
...
static const char *amixdownvol[]       = { "pulsemixer", "--change-volume", "-2", NULL };
static const char *amixupvol[]         = { "pulsemixer", "--change-volume", "+2",   NULL };
static const char *amixmutevol[]       = { "pulsemixer", "--toggle-mute", NULL };
